...
<div class="container-fluid red-background size">
	<div class="row">
		<div class="col-md-6 offset-md-3">
			<h1 class="text-center">About RAS-Blood-donation-team</h1>
			<!--<hr class="white-bar"> -->
		</div>
	</div>
</div>
<div class="container-fluid size">
	...
	<div class="container">
		...
		<div class="col-md-6">
			...
			<hr class="red-bar">
			<p>
			To provide the high quality and safe blood to the people fully free of cost!
			</p>
			<p>
			To provide the high quality and safe blood to the people fully free of cost!!!
			</p>
...
<div class="container-fluid white size">
	...
	<div class="container-fluid size">
		...
		<div class="col-md-6">
			...
			<p>
			To make blood donation 100% free. contact with us...!
			</p>
		</div>
	</div>
	</div>
